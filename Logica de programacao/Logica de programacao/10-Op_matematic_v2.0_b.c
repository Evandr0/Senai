/* Neste arquivo você poderá executar os exercicios G, H, I, J, K e L
Para executar os outros exercicios, abra o arquivo 10-Op_matematic_v2.0_a.c .*/
...
void loop()
{
    Serial.println("\nQual exercicio deseja executar letras G ateh L");
    ...
    if(exercicio > 12 || exercicio < 7) {
        Serial.println("\nExercicio digitado nao eh Valido ou esta no outro arquivo, tente novamente intervalo de 7 a 12\n");
    }
}
void exeG() {
    //Exercicio g) varf1 critico + bonus
	Serial.println("\nEste programa calcula o Dano critico + BONUS");
...
void exeH() {
    ...
    Serial.println("\nEste programa calcula a media ponderada de duas notas");
...
void exeI() {
    ...
    Serial.println("\nEste programa calcula quanto voce poupara em um mes.");
...
void exeK() {
    ...
    Serial.println("\nEste programa calcula a quantidade de cafe por Alunos.");
...
void exeL() {
    ...
    Serial.println("\nEste programa calcula a quantidade de cafe por Alunos + EXTRA.");
    Serial.print("Digite a quantidade de cafe em kilogramas: ");
    varf1 = le_numero_quebrado();
    Serial.println(varf1);
